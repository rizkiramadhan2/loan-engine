...
import (
	"simple-app/internal/pkg/log/logger"
)
...
// WithSlackNotification enable slack notification
// func WithSlackNotification(s *slack.Slack) {
// 	slackClient = s
// }

// SetLog set log based on level, create new log and set logger
func SetLog(level Level, filePath string, appName string) {
